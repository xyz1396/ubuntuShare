...
p <- ggvenn(pList)
p + ggsave("identified proteins venn.pdf",width = 8,height = 6)

#### if MS2 count==0 convert intensity to 0 ####
...
p <-
  p + scale_y_continuous(limits = c(0, 110), breaks = c(1.3, 10, 20, 40, 80, 160))
...
p <- drawVolcanoPlot(DEGsDf[, c("padj", "log2FoldChange")])
p <-
  p + scale_y_continuous(limits = c(0, 130), breaks = c(1.3, 10, 20, 40, 80, 160))
