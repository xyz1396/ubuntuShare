...
write.csv(results.pearson, "Physiology2Gene.pearson2.csv", row.names = F)
```
...
results.pearson <- cbind(r.pearson, p = p.pearson$p, qOrFdr = q.pearson$q)
write.csv(results.pearson, "Physiology2Physiology.pearson2.csv", row.names = F)
```
...
write.csv(results.spearman, "Physiology2Gene.spearman2.csv", row.names = F)
```
...
results.pearson <- cbind(r.pearson, p = p.pearson$p, qOrFdr = q.pearson$q)
write.csv(results.pearson, "Physiology2Physiology.Spearman2.csv", row.names = F)
```
