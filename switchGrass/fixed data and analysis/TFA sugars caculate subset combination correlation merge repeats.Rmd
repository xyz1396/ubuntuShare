...
getGene2Gene<-function(mat,fileName){
  results<-getGiniMatrix(mat)
  r<-results$corMatrix[12:19,12:19]
  r <- cbind(r, physiology = rownames(r))
  r.gini <-
    pivot_longer(as.data.frame(r),
                 -physiology,
  ...
  p<-results$pvalueMatrix[12:19,12:19]
  p <- cbind(as.data.frame(p), physiology = rownames(p))
  p.gini <-
    pivot_longer(as.data.frame(p),
                 -physiology,
...
getPhy2Gene(mat,"Physiology2Gene.TFAsugars.gini.csv")
mat<-cbind(gene2[,-1:-2],phy2[,-1:-2])
getPhy2Gene(mat,"Physiology2Gene.mergeRepeats.TFAsugars.gini.csv")
```
...
getPhy2Gene(mat,"N(GE) vs N + 1(CW)Physiology2Gene.mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"N(GE) vs N + 2(CW)Physiology2Gene.mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only NGE vs NCW.mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only	NGE vs N+1CW.mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only	NGE vs N+2CW.mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stage pairs NGE vs N+1CW V3 vs E4.mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stage pairs NGE vs N+1CW E4 vs R3 .mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; NvsN; N(GE) vs N(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; N(GE) vs N+1(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; N(GE) vs N+2 (CW).mergeRepeats.TFAsugars.gini.csv")
```
...
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N + 1(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N + 2(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N + 1(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N + 2(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N + 1(CW).mergeRepeats.TFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N + 2(CW).mergeRepeats.TFAsugars.gini.csv")
```
