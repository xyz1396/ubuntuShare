...
getPhy2Gene(mat,"N(GE) vs N + 1(CW)Physiology2Gene.mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"N(GE) vs N + 2(CW)Physiology2Gene.mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only NGE vs NCW.mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only	NGE vs N+1CW.mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only	NGE vs N+2CW.mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stage pairs NGE vs N+1CW V3 vs E4.mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stage pairs NGE vs N+1CW E4 vs R3 .mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; NvsN; N(GE) vs N(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; N(GE) vs N+1(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; N(GE) vs N+2 (CW).mergeRepeats.gini.csv")
```
...
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N + 1(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N + 2(CW).mergeRepeats.gini.csv")
```
...
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N + 1(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N + 2(CW).mergeRepeats.gini.csv")
```
...
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N + 1(CW).mergeRepeats.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N + 2(CW).mergeRepeats.gini.csv")
```
