---
title: "TFA sugars caculate subset combination correlation merge repeats"
author: "xyz"
date: "2021/2/19"
...
# merge repeats
phy2<-group_by(phy2,GeneType,Stage)
phy2<-summarise_all(phy2[,-3],mean)
gene2<-group_by(gene2,GeneType,Stage)
gene2<-summarise_all(gene2[,-3],mean)
```
...
mat<-cbind(gene2[,-1:-2],phy2[,-1:-2])
getPhy2Gene(mat,"Physiology2Gene.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"N(GE) vs N + 1(CW)Physiology2Gene.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"N(GE) vs N + 2(CW)Physiology2Gene.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only NGE vs NCW.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only	NGE vs N+1CW.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stages only	NGE vs N+2CW.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stage pairs NGE vs N+1CW V3 vs E4.mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Stage pairs NGE vs N+1CW E4 vs R3 .mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; NvsN; N(GE) vs N(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; N(GE) vs N+1(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Segments only; N(GE) vs N+2 (CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(geneA4[,-1:-2],phyA4[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N + 1(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; A4; N(GE) vs N + 2(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(geneAP13[,-1:-2],phyAP13[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N + 1(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; AP13; N(GE) vs N + 2(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(geneVS16[,-1:-2],phyVS16[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N + 1(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
...
mat<-cbind(gene3[,-1:-2],phy3[,-1:-2])
getPhy2Gene(mat,"Genotypes only; VS16; N(GE) vs N + 2(CW).mergeRepeats.withoutTFAsugars.gini.csv")
```
