...
set.seed(9527)
cl <- mfuzz(eset.s, c = 5, m = m)
pdf("mfuzz clust 5.pdf",width = 15,height = 9)
mfuzz.plot(
  eset.s,
  cl,
  mfrow = c(2, 3),
...
dev.off()
proteinCluster5<-cl$cluster
proteinCluster5<-data.frame(Protein=names(proteinCluster5),Cluster=proteinCluster5)
saveRDS(proteinCluster5,"proteinCluster5.rds")
```
