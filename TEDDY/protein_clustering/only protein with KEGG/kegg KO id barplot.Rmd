...
write.csv(drawDf, "cluster10 top 10 KO id table.csv", row.names = F)
...
p <- ggplot(drawDf) +
  ...
  ylab("Abundance (%)") +
  scale_fill_discrete(name = "Orthology")+
  theme(
...
p + ggsave("protein cluster abundance barplot KEGG Orthology id.pdf",
           width = 12,
           height = 6)
```
